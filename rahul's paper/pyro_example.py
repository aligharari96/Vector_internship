    ...
    def model(
        ...
        with pyro.plate("z_minibatch", len(mini_batch)):
            ...
            for t in pyro.markov(range(1, T_max + 1)):
                ...
                #z_loc = torch.ones_like(z_scale)*2
                ...
                #print('emitter', z_t[0][0])
                #print(emission_probs_t[0][0])
    ...
    def guide(
        ...
        with pyro.plate("z_minibatch", len(mini_batch)):
            ...
            for t in pyro.markov(range(1, T_max + 1)):
                ...
                #print(z_loc.shape)
                #print(111,z_loc[0][0])
                #z_scale = z_scale/1000
                #print(z_prev)
                #print(self.combiner.lin_z_to_hidden.weight)
                #print(z_scale)
                #print(z_loc)
                #assert 0
...
def main(args):
    ...
    adam = torch.optim.Adam(dmm.parameters(), lr=1e-3)
    ...
    def process_minibatch(epoch, which_mini_batch, shuffled_indices):
        ...
        #print(torch.sum(mini_batch[0]), mini_batch.shape)
        #assert 0
        #mini_batch_mask[0,1:] = 0.0
        #torch.randn((10,))
        loss = svi.step(
            mini_batch,
            mini_batch_reversed,
        ...
        print(dmm.emitter.lin_hidden_to_hidden.weight.grad)
        assert 0
        #print(annealing_factor)
        #print(mini_batch_mask,mini_batch_seq_lengths)
        print(annealing_factor,  loss/torch.sum(mini_batch_seq_lengths))
        #assert 0
        #print(loss/torch.sum(mini_batch_seq_lengths)-15.3250)
        #assert 0
...
if __name__ == "__main__":
    ...
    parser.add_argument("-lrd", "--lr-decay", type=float, default=1)
    ...
    parser.add_argument("-smod", "--save-model", type=str, default="dmm.pt")
